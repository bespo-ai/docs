...
<Steps>
  ...
  <Step title="Review and run the script">
    ...
    When you're ready, click **Run** to execute the script. The agent runs it inside a secure sandbox and streams the output back to your chat session so you can see what happened.
