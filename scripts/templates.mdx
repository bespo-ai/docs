...
<Steps>
  ...
  <Step title="Choose a template in your workspace">
    After you select a template in the app, Script.it copies the template script into your workspace with its blocks, source files, and supporting data files, so you have a full, editable copy.
  </Step>
