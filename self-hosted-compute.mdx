...
<img
  src="/images/relay-architecture-light.svg"
  alt="A relay on one Linux VM inside your network hosts agent environments, which reach your internal systems directly. Two outbound connections leave your network: the relay's control connection, and the environments' own traffic for integrations, model calls, and code sync."
  className="block dark:hidden w-full"
  noZoom
/>
<img
  src="/images/relay-architecture-dark.svg"
  alt="A relay on one Linux VM inside your network hosts agent environments, which reach your internal systems directly. Two outbound connections leave your network: the relay's control connection, and the environments' own traffic for integrations, model calls, and code sync."
  className="hidden dark:block w-full"
  noZoom
/>

Two connections leave your network, both opened from your side. The **control connection** is how Script.it drives your environments. The second carries the environments' own traffic — connected integrations, model calls, and code sync.
