...
Workspaces are where you collaborate in Script.it. Each workspace holds its own scripts and gives members a shared place to use integrations that have been shared with the workspace.

When you sign up, Script.it creates a private workspace for you automatically. You can create additional workspaces for teams, clients, departments, or any other collaboration boundary.
